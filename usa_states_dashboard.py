...
with tab1:
    ...
    fig_pop2003 = px.scatter_mapbox(gdf_filtered,
                                    lat=gdf_filtered.centroid.y,
                                    lon=gdf_filtered.centroid.x,
...
with tab2:
    ...
    fig_white = px.scatter_mapbox(gdf_filtered,
                                  lat=gdf_filtered.centroid.y,lon=gdf_filtered.centroid.x,
...
with tab3:
    ...
    fig_females = px.scatter_mapbox(gdf_filtered,
                                    lat=gdf_filtered.centroid.y,lon=gdf_filtered.centroid.x,
